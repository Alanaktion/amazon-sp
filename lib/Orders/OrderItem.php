...
'product_info' => '\AmazonSP\Orders\ProductInfoDetail',
'points_granted' => '\AmazonSP\Orders\PointsGrantedDetail',
'item_price' => '\AmazonSP\Orders\Money',
'shipping_price' => '\AmazonSP\Orders\Money',
'item_tax' => '\AmazonSP\Orders\Money',
'shipping_tax' => '\AmazonSP\Orders\Money',
'shipping_discount' => '\AmazonSP\Orders\Money',
'shipping_discount_tax' => '\AmazonSP\Orders\Money',
'promotion_discount' => '\AmazonSP\Orders\Money',
'promotion_discount_tax' => '\AmazonSP\Orders\Money',
'promotion_ids' => '\AmazonSP\Orders\PromotionIdList',
'cod_fee' => '\AmazonSP\Orders\Money',
'cod_fee_discount' => '\AmazonSP\Orders\Money',
'is_gift' => 'bool',
...
'tax_collection' => '\AmazonSP\Orders\TaxCollection',
...
self::DEEMED_RESELLER_CATEGORY_UOSS,        ];
     ...
     * Gets product_info
     *
     * @return \AmazonSP\Orders\ProductInfoDetail
     */
     ...
     * Sets product_info
     *
     * @param \AmazonSP\Orders\ProductInfoDetail $product_info product_info
     *
     * @return $this
     */
     ...
     * Gets points_granted
     *
     * @return \AmazonSP\Orders\PointsGrantedDetail
     */
     ...
     * Sets points_granted
     *
     * @param \AmazonSP\Orders\PointsGrantedDetail $points_granted points_granted
     *
     * @return $this
     */
     ...
     * Sets item_price
     *
     * @param \AmazonSP\Orders\Money $item_price item_price
     *
     * @return $this
     */
     ...
     * Sets shipping_price
     *
     * @param \AmazonSP\Orders\Money $shipping_price shipping_price
     *
     * @return $this
     */
     ...
     * Sets item_tax
     *
     * @param \AmazonSP\Orders\Money $item_tax item_tax
     *
     * @return $this
     */
     ...
     * Sets shipping_tax
     *
     * @param \AmazonSP\Orders\Money $shipping_tax shipping_tax
     *
     * @return $this
     */
     ...
     *
     * @param \AmazonSP\Orders\Money $shipping_discount shipping_discount
     *
     * @return $this
     */
     ...
     *
     * @param \AmazonSP\Orders\Money $shipping_discount_tax shipping_discount_tax
     *
     * @return $this
     */
     ...
     *
     * @param \AmazonSP\Orders\Money $promotion_discount promotion_discount
     *
     * @return $this
     */
     ...
     *
     * @param \AmazonSP\Orders\Money $promotion_discount_tax promotion_discount_tax
     *
     * @return $this
     */
     ...
     * Gets promotion_ids
     *
     * @return \AmazonSP\Orders\PromotionIdList
     */
     ...
     * Sets promotion_ids
     *
     * @param \AmazonSP\Orders\PromotionIdList $promotion_ids promotion_ids
     *
     * @return $this
     */
     ...
     * Sets cod_fee
     *
     * @param \AmazonSP\Orders\Money $cod_fee cod_fee
     *
     * @return $this
     */
     ...
     *
     * @param \AmazonSP\Orders\Money $cod_fee_discount cod_fee_discount
     *
     * @return $this
     */
     ...
     * Gets tax_collection
     *
     * @return \AmazonSP\Orders\TaxCollection
     */
     ...
     * Sets tax_collection
     *
     * @param \AmazonSP\Orders\TaxCollection $tax_collection tax_collection
     *
     * @return $this
     */
