...
# **cancelFeed**
> \AmazonSP\Feeds\CancelFeedResponse cancelFeed($feed_id)
...
$apiInstance = new AmazonSP\Api\FeedsApi(
...
[**\AmazonSP\Feeds\CancelFeedResponse**](../Model/CancelFeedResponse.md)
...
# **createFeed**
> \AmazonSP\Feeds\CreateFeedResponse createFeed($body)
...
$body = new \AmazonSP\Feeds\CreateFeedSpecification(); // \AmazonSP\Feeds\CreateFeedSpecification | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\AmazonSP\Feeds\CreateFeedSpecification**](../Model/CreateFeedSpecification.md)|  |

### Return type

[**\AmazonSP\Feeds\CreateFeedResponse**](../Model/CreateFeedResponse.md)
...
# **createFeedDocument**
> \AmazonSP\Feeds\CreateFeedDocumentResponse createFeedDocument($body)
...
$body = new \AmazonSP\Feeds\CreateFeedDocumentSpecification(); // \AmazonSP\Feeds\CreateFeedDocumentSpecification | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\AmazonSP\Feeds\CreateFeedDocumentSpecification**](../Model/CreateFeedDocumentSpecification.md)|  |

### Return type

[**\AmazonSP\Feeds\CreateFeedDocumentResponse**](../Model/CreateFeedDocumentResponse.md)
...
# **getFeed**
> \AmazonSP\Feeds\GetFeedResponse getFeed($feed_id)
...
[**\AmazonSP\Feeds\GetFeedResponse**](../Model/GetFeedResponse.md)
...
# **getFeedDocument**
> \AmazonSP\Feeds\GetFeedDocumentResponse getFeedDocument($feed_document_id)
...
[**\AmazonSP\Feeds\GetFeedDocumentResponse**](../Model/GetFeedDocumentResponse.md)
...
# **getFeeds**
> \AmazonSP\Feeds\GetFeedsResponse getFeeds($feed_types, $marketplace_ids, $page_size, $processing_statuses, $created_since, $created_until, $next_token)
...
[**\AmazonSP\Feeds\GetFeedsResponse**](../Model/GetFeedsResponse.md)
