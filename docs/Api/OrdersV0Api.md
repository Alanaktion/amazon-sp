...
# **getOrder**
> \AmazonSP\Orders\GetOrderResponse getOrder($order_id)
...
[**\AmazonSP\Orders\GetOrderResponse**](../Model/GetOrderResponse.md)
...
# **getOrderAddress**
> \AmazonSP\Orders\GetOrderAddressResponse getOrderAddress($order_id)
...
[**\AmazonSP\Orders\GetOrderAddressResponse**](../Model/GetOrderAddressResponse.md)
...
# **getOrderBuyerInfo**
> \AmazonSP\Orders\GetOrderBuyerInfoResponse getOrderBuyerInfo($order_id)
...
[**\AmazonSP\Orders\GetOrderBuyerInfoResponse**](../Model/GetOrderBuyerInfoResponse.md)
...
# **getOrderItems**
> \AmazonSP\Orders\GetOrderItemsResponse getOrderItems($order_id, $next_token)
...
[**\AmazonSP\Orders\GetOrderItemsResponse**](../Model/GetOrderItemsResponse.md)
...
> \AmazonSP\Orders\GetOrderItemsBuyerInfoResponse getOrderItemsBuyerInfo($order_id, $next_token)
...
[**\AmazonSP\Orders\GetOrderItemsBuyerInfoResponse**](../Model/GetOrderItemsBuyerInfoResponse.md)
...
# **getOrders**
> \AmazonSP\Orders\GetOrdersResponse getOrders($marketplace_ids, $created_after, $created_before, $last_updated_after, $last_updated_before, $order_statuses, $fulfillment_channels, $payment_methods, $buyer_email, $seller_order_id, $max_results_per_page, $easy_ship_shipment_statuses, $next_token, $amazon_order_ids)
...
[**\AmazonSP\Orders\GetOrdersResponse**](../Model/GetOrdersResponse.md)
